...
exports.transformTypeormEntity = void 0;
const format_1 = require("./format");
function transformTypeormEntity(_fileContent, entityLibName) {
    let fileContent = (0, format_1.formatTS)(_fileContent);
    ...
    result.forEach((i) => {
        ...
        const hasTypeormFrom = hasFrom && (i.indexOf(` '${entityLibName}`) > -1 || i.indexOf(` "${entityLibName}`) > -1);
        ...
        const hasDecoratorEnd2 = decoratorArr.length > 0 && (_i.indexOf('})') > -1 || _i.indexOf(')') > -1);
    ...
    return (0, format_1.formatTS)(fileContent);
}
exports.transformTypeormEntity = transformTypeormEntity;
